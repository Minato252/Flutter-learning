...
class SqlUtil extends BaseModel {
  ...
  //修改一条或多条数据 单个条件
  Future<int> update(
      Map<String, dynamic> params, String key, dynamic value) async {
    return await this
        .db
        .update(tableName, params, where: '$key = ?', whereArgs: [value]);
  }

  //修改一条或多条数据 多个条件
  Future<int> updates(Map<String, dynamic> params,
      Map<String, dynamic> conditions, String ao) async {
    String stringConditions = '';
