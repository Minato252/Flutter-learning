...
class AdminSearchMessagePage extends StatefulWidget {
  List conList;
  AdminSearchMessagePage({Key key, this.conList}) : super(key: key);

  _AdminSearchMessagePageState createState() =>
      _AdminSearchMessagePageState(conList = conList);
}

class _AdminSearchMessagePageState extends State<AdminSearchMessagePage>
  ...
  _AdminSearchMessagePageState(List list) {
    this.conList = list;
  }
...
//{"title":"1群","keyWord":"1群","htmlCode":"<p><span style=\"font-size:15px;\">看头像</span></p><p><span style=\"font-size:15px;\">转发</span></p><p><span style=\"font-size:15px;color: red\">以下是由12345567修改，时间为：2021-03-28 10:21:15</span></p><p><span style=\"font-size:15px;\">转发测试</span></p>","hadLook":"wyyy(2021-03-28 10:21:15)","messageId":null}
  ...
  void didTapConversation(Conversation conversation) {
    ...
    Navigator.pushNamed(context, '/adminsearchConversation', arguments: arg);
