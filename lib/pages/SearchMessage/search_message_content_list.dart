...
class SearchMessageContentList extends StatefulWidget {
  MessageContentListDelegate delegate;
  List messageDataSource = new List();
  bool multiSelect;
  List selectedMessageIds = new List();
  _SearchMessageContentListState state;
  Map burnMsgMap = Map();
  SearchMessageContentList(
  ...
  State<StatefulWidget> createState() {
    return state = _SearchMessageContentListState(messageDataSource,
        multiSelect, selectedMessageIds, delegate, burnMsgMap);
  }
}

class _SearchMessageContentListState extends State<SearchMessageContentList>
  ...
  _SearchMessageContentListState(
      List messageDataSource,
      bool multiSelect,
      List selectedMessageIds,
      MessageContentListDelegate delegate,
  ...
  void initState() {
    ...
    EventBus.instance.addListener(EventKeys.BurnMessage, (map) {
      ...
      SearchConversationItem item = conversationItems[messageId];
          ...
          return ListView.separated(
              ...
              itemBuilder: (BuildContext context, int index) {
                if (messageDataSource.length != null &&
                  ...
                  SearchConversationItem item = SearchConversationItem(
                      this,
                      tempMessage,
  ...
  void _refrshItem(Message msg) {
    SearchConversationItem item = conversationItems[msg.messageId];
    item?.refreshUI(msg);
  }
