...
class _ALLReadSearchConversationPageState
  ...
  SearchMessageContentList messageContentList;
  ...
  void initState() {
    ...
    messageContentList = SearchMessageContentList(
...
//conversationType==RCConversationType.Group?
  ...
  void dispose() {
    ...
    // EventBus.instance.commit(EventKeys.SearchConversationPageDispose, null);
