...
import 'package:weitong/pages/group/GroupshelterPre.dart';
...
class GroupShelterMessageCreate extends StatefulWidget {
  ...
  GroupShelterMessageCreate({Key key, this.targetGroupId, this.title})
      : super(key: key);

  @override
  _GroupShelterMessageCreateState createState() =>
      _GroupShelterMessageCreateState(
          targetGroupId = targetGroupId, title = title);
  /*targetGroupId = targetGroupId, title = title*/
}

class _GroupShelterMessageCreateState extends State<GroupShelterMessageCreate>
  ...
  String targetGroupId;
  String title;
  _GroupShelterMessageCreateState(String targetGroupId, String title) {
    //富文本的controller
